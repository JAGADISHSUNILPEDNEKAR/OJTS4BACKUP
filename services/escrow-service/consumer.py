...
from kafka_producer import publish_to_dlq

CONSUMER_GROUP = "escrow-service-group"
    ...
    try:
        ...
        async for msg in consumer:
            ...
            try:
                ...
                logger.exception(f"Processing failed for {topic}: {e}")
                await publish_to_dlq(topic, event, e, CONSUMER_GROUP)
